...
module.exports = async (req, res, next) => {
    ...
    await usernameValidation.Length(4).IsInUse()
    ...
    displayNameValidation.Length(4).NotContainSpecial()
    ...
    await emailValidation.IsEmail().IsInUse()
    ...
    await passwordValidation.Length(8).ContainLowercase().ContainUppercase().ContainNumber().ContainSpecial()
